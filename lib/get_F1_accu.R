...
Fun1 = function(R,y,init_label){
  ...
  q1 <- R[1]
  q2 <- R[2]
  a_b = init_label[q1]==init_label[q2]
  a = (init_label[q1]==init_label[q2])&(y[q1]==y[q2])
  return(c(a = a, a_b = a_b))
}

get_F1_accu = function(init_label,data,A_C = a_c,B_D = b_d){
  ...
  df = apply(pairlist,1,Fun1,y,init_label)
  #stopCluster(cl2)

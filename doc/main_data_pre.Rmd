...
# score <- rep(NA,ncol(labels))
# get_score <- function(labels){
#   for (i in 1:ncol(labels)){
#     Fea_wol_1 <- cbind(Fea_wol,label_1=labels[,i])
#     Fea_wol_1 <- aggregate(Fea_wol_1,by=list(label_1),FUN=mean)
#     score[i]=sum(Fea_wol_1[,-c("label_1")]%*%lamda)
#   }
#   
# }
```

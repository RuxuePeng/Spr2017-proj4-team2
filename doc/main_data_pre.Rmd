...
```{r}
packages.used=c("plyr","text2vec","qlcMatrix")
...
```{r}
# setwd("/Users/ZHANGJIAHAO/Spr2017-proj4-team2/data/nameset")
...
create_data <- function(filename){
  ...
  #write(tmp$V1,"tmp_1.txt",sep = "\n")
  #tmp_1 <- strsplit(tmp,split = ">")
...
dtm_test <- as.matrix(dtm_train_tfidf)
